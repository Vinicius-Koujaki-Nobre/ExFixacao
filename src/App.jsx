    ...
    <>
      ...
      <section className={style.sections1} id='s1'>
        ...
        <div className={style.belowContent}>
          ...
          {Message && (
            <p className={style.p}>Genki Dama é um poderoso ataque em Dragon Ball, considerado o ataque mais poderoso da série, mas depende do número de organismos suportando seu uso. No manga, é usado apenas um total de três vezes.</p>
          )}
        </div>
      </section>
